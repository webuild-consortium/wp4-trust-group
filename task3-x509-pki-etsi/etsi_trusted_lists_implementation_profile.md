...
**ETSI TS 119 602 v1.1.1 (2025-11)** (per ARF v3.0.0 STS list) (“Lists of trusted entities; Data model”) defines:
...
- [Commission Implementing Regulation (EU) 2025/2164](https://eur-lex.europa.eu/eli/reg_impl/2025/2164/oj) – trusted lists / TS 119 612 (marked Done in ARF v3.0.0 STS list)
