...
- **ARF**: [EUDI Wallet Architecture and Reference Framework 3.0.0](https://eudi.dev/3.0.0/architecture-and-reference-framework-main/), [Annex II - High-Level Requirements](https://eudi.dev/3.0.0/annexes/annex-2/annex-2.02-high-level-requirements-by-topic/)
