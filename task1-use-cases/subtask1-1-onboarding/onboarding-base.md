...
- **ARF**: [EUDI Wallet Architecture and Reference Framework 2.7.3](https://eudi.dev/2.7.3/architecture-and-reference-framework-main/), [Annex II - High-Level Requirements](https://eudi.dev/2.7.3/annexes/annex-2/annex-2.02-high-level-requirements-by-topic/)
