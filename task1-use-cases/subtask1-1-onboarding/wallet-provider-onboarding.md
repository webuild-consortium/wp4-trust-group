...
For common onboarding framework elements shared with Relying Parties and PID/EAA Providers, see [Base Onboarding Framework](onboarding-base.md).
...
- **Prerequisites [MVP+]**:
    ...
    - The Wallet Provider was able to successfully certify its wallet solution according to [CIR 2024/2981](https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=OJ:L_202402981)
...
See [Common Normative References](onboarding-base.md#common-normative-references) for all references applicable to Wallet Provider onboarding processes, including Wallet Provider-specific references.
