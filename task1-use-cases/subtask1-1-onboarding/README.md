...
- **`relying-party-registry-onboarding.md`** – MVP operational guide: Wallet Relying Party registration in the Raidiam EUDI Trust Registry Sandbox (WRPAC issuance and `GET /wrp`)
...
| A **Relying Party** joining the WE BUILD pilot registry | **[Wallet Relying Party Registry Onboarding](relying-party-registry-onboarding.md)** (operational). Use case: [UC-01](relying_party_onboarding.md). |
