...
This task collects the high‑level use cases that drive the design of the WP4 Trust Infrastructure, with a focus on onboarding participants and operating the trust registry.
...
- **Trust registry scenarios**: Define how trusted lists, trust anchors, trust levels and trust chains are created, evaluated, maintained and revoked, including [trust evaluation use cases](subtask1-2-trust-registry/README.md), [UC-RPI-01 Relying Party Intermediary](subtask1-2-trust-registry/relying-party-intermediary-use-case.md), and [UC-TE-07 European Business Wallet](subtask1-2-trust-registry/european-business-wallet-trust-evaluation.md).
