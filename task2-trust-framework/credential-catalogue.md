...
This document compiles evidence, references, and specifications for the EUDI Wallet **catalogue of attributes** and **catalogue of attestation schemes**, as defined in the Architecture and Reference Framework (ARF) v3.0.0 and Commission Implementing Regulation (EU) 2025/1569.
...
#### Main Architecture Document (ARF v3.0.0)
- [Section 5.5 - Catalogue of attributes and catalogue of attestation schemes](https://eudi.dev/3.0.0/architecture-and-reference-framework-main/#55-catalogue-of-attributes-and-catalogue-of-attestation-schemes)

#### Discussion Paper
- [Topic O - Catalogues for Attestations](https://eudi.dev/3.0.0/discussion-topics/o-catalogues-for-attestations/) (Version 1.0, updated 29 Sep 2025)
...
#### Requirements Documents (ARF v3.0.0 Annex 2.02)
- [Topic 25 - Unified definition and controlled vocabularies for attributes](https://eudi.dev/3.0.0/annexes/annex-2/annex-2.02-high-level-requirements-by-topic/#a2315-topic-25---unified-definition-and-controlled-vocabularies-for-attributes)
- Topic 26 (References to catalogue of Attestation Rulebooks) has been removed in ARF v3.0.0; see [Discussion Paper Topic O](https://eudi.dev/3.0.0/discussion-topics/o-catalogues-for-attestations/) Section 3.2.
...
From **Topic 25** (ARF v3.0.0 Annex 2.02; former catalogue HLRs have been removed per Discussion Paper Topic O):
...
From **Topic 12** (Attestation Rulebooks, ARF v3.0.0 Annex 2.02):
...
- Registration in catalogues is **not mandatory** for QEAAs and PuB-EAAs (ARF v3.0.0 Section 5.5.3).
- Registration does not create any obligation for acceptance of the relevant type of attestation by any actor. Neither does it automatically imply cross-border recognition (ARF v3.0.0 Section 5.5.3).
...
- ARF v3.0.0 has incorporated the changes discussed in [Discussion Paper Topic O](https://eudi.dev/3.0.0/discussion-topics/o-catalogues-for-attestations/): the former HLRs in Topics 25 and 26 have been removed; Topic 25 now contains only CAT_04 (verification point for attributes), and Topic 26 has been removed.
...
## Related Topics and Cross-References (ARF v3.0.0)

- [Topic 12 - Attestation Rulebooks](https://eudi.dev/3.0.0/annexes/annex-2/annex-2.02-high-level-requirements-by-topic/#a239-topic-12---attestation-rulebooks)
- [Topic 25 - Unified definition and controlled vocabularies for attributes](https://eudi.dev/3.0.0/annexes/annex-2/annex-2.02-high-level-requirements-by-topic/#a2315-topic-25---unified-definition-and-controlled-vocabularies-for-attributes)
- Topic 26 - Removed in ARF v3.0.0; see [Discussion Paper Topic O](https://eudi.dev/3.0.0/discussion-topics/o-catalogues-for-attestations/) Section 3.2.
- [Topic 42 - Requirements for QTSPs to Access Authentic Sources](https://eudi.dev/3.0.0/annexes/annex-2/annex-2.02-high-level-requirements-by-topic/#a2324-topic-42---requirements-for-qtsps-to-access-authentic-sources) - Related to the catalogue of attributes (verification points)
...
### Architecture Documents (ARF v3.0.0)
