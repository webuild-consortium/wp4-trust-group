...
The **EUDI Trusted Lists Inspector** is an open-source tool for testing, validating and debugging EUDI trust infrastructure artifacts.
...
The tool has a Web GUI, OpenAPI documentation, source code available under Apache 2.0, and is deployed at a stable URL.
...
For **onboarding** a participant into a WE BUILD Trusted List (as opposed to auditing published lists), see [Onboarding to the Trusted Lists](../task1-use-cases/subtask1-1-onboarding/trusted-lists-onboarding.md) and the companion console at [lote.credimi.io](https://lote.credimi.io/).
